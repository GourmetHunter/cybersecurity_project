...
import sec.project.repository.HitsRepository;
import sec.project.repository.NewsObjectRepository;
...
public class NewsController {
    ...
    @GetMapping("/news/{id}/remove") // remove a news article
    ...
    public String postContent(@RequestParam String title, @RequestParam String content, @RequestParam String category, @RequestParam String author) throws IOException {
